...
const CONFIG = {
    ...
    AVAILABLE_MODELS: [
        ...
        { id: 'gemini-3.8-flash', label: 'Gemini 3.8 Flash', tag: 'OKMD', provider: 'okmd', icon: 'gemini' },
        { id: 'gemini-3.7-flash', label: 'Gemini 3.7 Flash', tag: 'OKMD', provider: 'okmd', icon: 'gemini' },
        { id: 'gemini-3.5-flash', label: 'Gemini 3.5 Flash', tag: 'OKMD', provider: 'okmd', icon: 'gemini' },
        { id: 'gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro Preview', tag: 'OKMD', provider: 'okmd', icon: 'gemini' },
        { id: 'gemini-3.1-flash-lite', label: 'Gemini 3.1 Flash Lite', tag: 'OKMD', provider: 'okmd', icon: 'gemini' },
        { id: 'gemini-3.1-flash-lite-preview', label: 'Gemini 3.1 Flash Lite Preview', tag: 'OKMD', provider: 'okmd', icon: 'gemini' },
        ...
        { id: 'sonar-pro', label: 'Perplexity Sonar Pro', tag: 'OKMD', provider: 'okmd', icon: 'perplexity' },
        ...
        { id: 'qwen3.5-9b', label: 'Qwen 3.5 9B', tag: 'OKMD', provider: 'okmd', icon: 'qwen' },
